      ...
      <div style={{ borderRadius:"1.65rem", overflow:"hidden" }}>
        ...
        <div style={{ padding:"1.65rem" }}>
          ...
          <div style={{ display:"flex", gap:"0.75rem", flexWrap:"wrap" }}>
            ...
            <GlowBtn wa href={buildWA(`Hi Keystone Cleaner, I'm interested in ${service.title}. Can I get a quote?`)} target="_blank" rel="noopener noreferrer"><MessageCircle size={15}/> WhatsApp</GlowBtn>
          </div>
        </div>
      </div>
    </Modal>
